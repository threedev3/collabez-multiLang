        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 relative  place-items-center w-full z-10">
          {portfolioItems.map((portfolio, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center gap-1 sm:py-3 py-1.5 sm:px-3 px-3 w-[95%] mx-auto border border-white/35 absolute bottom-4 left-0 right-0 backdrop-blur-sm bg-white/10">
